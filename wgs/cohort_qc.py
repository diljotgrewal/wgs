...
def cohort_qc_workflow(args):
    ...
    #     func="wgs.workflows.cohort_qc.cna_annotaion_workflow",
    #     axes=("cohort_label",),
    #     args=(
    #         mgd.InputFile('remixt_dict', 'cohort_label', 'sample_label', fnames=remixt_data, axes_origin=[]),
    #         # mgd.InputFile('remixt', 'cohort_label', 'sample_label', fnames=remixt_data),
    #         mgd.OutputFile('cohort_cna', 'cohort_label', fnames=cna_table),
    #     )
    # )
    ...
    workflow.subworkflow(
        ...
        args=(
            ...
            # mgd.OutputFile('cohort_maf', 'cohort_label', fnames=cohort_maf),
